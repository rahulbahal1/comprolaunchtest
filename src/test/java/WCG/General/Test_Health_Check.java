...
public class Test_Health_Check extends global{ 
	String s = "fasle";  
	private String testEnv;
	private RemoteWebDriver driver = null;
	public Test_Health_Check(String testEnv){
...
@Ignore
public void Test_Health_0()throws Exception{
System.out.println("In @Test");
Health_check h = new Health_check();
CSVHandler login_details = new CSVHandler("src/test/resources/login_health_check.csv");
...
@Test
public void Test_Health_1()throws Exception{
...
result = Screenshot.compareScreenshots("actual_health_"+baseurl0_name, "image1");
...
//Check Screenshots
@Test
public void TestHealth_2()throws Exception{
...
general = new CSVHandler("src/test/resources/login_health_check.csv");
String text;
String check = "false";
...
@Test
public void TestHealth_3()throws Exception{
System.out.println(global_check);
if(!global_check.equals("true"))
{	
...
@Test 
public void TestHealth_4()throws Exception{
System.out.println(global_check);
if(!global_check.equals("true"))
{	
...
@Test
public void TestHealth_5()throws Exception{
System.out.println(global_check);
if(!global_check.equals("true"))
{	
...
@Test
public void TestHealth_7()throws Exception{
System.out.println(global_check);
String server;
String text;
String check = "false";
...
@Test 
public void TestHealth_8()throws Exception{
System.out.println(global_check);
if(!global_check.equals("true"))
{	
...
@Test 
public void TestHealth_9()throws Exception{
System.out.println(global_check);
if(!global_check.equals("true"))
{	
...
@Test 
public void TestHealth_10()throws Exception{
System.out.println(global_check);
if(!global_check.equals("true"))
{	
